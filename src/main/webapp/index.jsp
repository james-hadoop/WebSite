...
<body>
 ...
 <div class="container-fluid" style="padding: 0;">
  ...
  <div class="row my-main1">
   <div class="col-xs-12">
    <div class="carousel slide" id="my-carousel" data-ride="carousel" data-interval="2000">
     ...
     <!--控制箭头-->
     <a href="#my-carousel" class="carousel-control left" data-slide="prev"> <span
      class="glyphicon glyphicon-chevron-left"></span>
     </a> <a href="#my-carousel" class="carousel-control right" data-slide="next"> <span
  ...
  <div class="row my-main2">
   ...
   <div class="col-md-3 col-sm-6 col-xs-12">
    <a i class="items_a"><img src="" class="img-responsive items"></a>
   </div>
  </div>
 </div>
