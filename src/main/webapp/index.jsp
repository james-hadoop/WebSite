...
<body>
  ...
  <div class="container-fluid" style="padding:0;">
    <div class="row my-main1">
      <div class="col-xs-12">
        <a href="shijian1.html"><img id="lunbo1" src="image/lunbo1.jpg" class="img-responsive"></a>
      </div>
    </div>
    ...
    <div class="row my-main2">
      <div class="col-md-3 col-sm-6 col-xs-12">
        <a id="my-img2-1" href="shijian2.html"><img src="" class="img-responsive lunbo"></a>
      </div>
      <div class="col-md-3 col-sm-6 col-xs-12">
        <a id="my-img2-2" href="shijian3.html"><img src="" class="img-responsive lunbo"></a>
      </div>
      <div class="col-md-3 col-sm-6 col-xs-12">
        <a id="my-img2-3" href="shijian4.html"><img src="" class="img-responsive lunbo"></a>
      </div>
      <div class="col-md-3 col-sm-6 col-xs-12">
        <a id="my-img2-4" href="shijian5.html"><img src="" class="img-responsive lunbo"></a>
      </div>
    </div>
  </div>
